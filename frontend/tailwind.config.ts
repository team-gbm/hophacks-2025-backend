  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "medical-surface-secondary": "#f1f5f9",
        "medical-success": "#22c55e",
      },
      backgroundImage: {
        "gradient-medical": "linear-gradient(135deg, #0ea5e9 0%, #10b981 100%)",
        "gradient-surface": "linear-gradient(to bottom, #f8fafc, #ffffff)",
      },
      boxShadow: {
        "medical": "0 10px 25px -5px rgba(14, 165, 233, 0.1), 0 4px 6px -2px rgba(14, 165, 233, 0.05)",
